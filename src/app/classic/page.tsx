...
import { skills, abilities, techStack } from '@/content/profile';
    ...
    <>
      ...
      <div className="text-white overflow-x-hidden relative">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] rounded-full bg-white/[0.02] blur-[120px]" />
          <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-white/[0.02] blur-[100px]" />
          <div className="absolute top-[40%] right-[-15%] w-[400px] h-[400px] rounded-full bg-white/[0.015] blur-[100px]" />
        </div>
        ...
        <section id="about" className="relative py-28 md:py-36 px-6 z-10">
          <div className="max-w-6xl mx-auto">
            <FadeSection className="text-center">
              ...
              <p className="text-white/45 max-w-2xl mx-auto text-base leading-relaxed mb-16">
        ...
        <section id="skills" className="relative py-28 md:py-36 px-6 z-10">
          <div className="max-w-6xl mx-auto">
            <FadeSection className="text-center">
              ...
              <p className="text-white/45 max-w-xl mx-auto text-base leading-relaxed mb-16">
